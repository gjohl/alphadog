...
class TestForecast:
    ...
    def test_run_signals_single_col_input(self, mock_price):
        ...
        expected_capped_df = pd.DataFrame(
            [7.920792079207921, 8.118811881188119, 8.316831683168317, 8.514851485148515, 8.712871287128714, 8.910891089108912, 9.10891089108911, 9.306930693069308, 9.504950495049506, 9.702970297029703, 9.900990099009901, 10.099009900990099, 10.297029702970297, 10.495049504950495, 10.693069306930694, 10.891089108910892, 11.08910891089109, 11.287128712871288, 11.485148514851486, 11.683168316831683, 20.0, -20.0],
            index=pd.to_datetime(['2019-01-01', '2019-01-02', '2019-01-03', '2019-01-04',
                                  '2019-01-07', '2019-01-08', '2019-01-09', '2019-01-10',
                                  '2019-01-11', '2019-01-14', '2019-01-15', '2019-01-16',
                                  '2019-01-17', '2019-01-18', '2019-01-21', '2019-01-22',
