...
from alphadog.internals.analytics import (
    cross_sectional_mean, arithmetic_returns, geometric_returns, returns
)
...
class TestCrossSectionalMean:
    ...
    def test_multicolumn_with_intermittent_nans(self):
        pass

    def test_empty_multicolumn_dataframe(self):
        pass
